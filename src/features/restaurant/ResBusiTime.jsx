...
export default function ResBussiTime({
	...
	return (
		<div className="flex justify-center pb-8">
			<div className="py-2 my-4 flex gap-4 shadow-lg border px-60 bg-white">
				<div className="px-4 py-2 ">
					{/* Table Current */}
					<h1 className="text-center text-xl mb-2 font-semibold">
						Current
					</h1>
					<div className="grid grid-cols-12 gap-2 px-4 py-2 items-center justify-items-center bg-gray-600 text-white font-semibold">
					...
					{resById?.BusinessTimes?.length === 0 ? (
						<>
							<div className="grid grid-cols-12 gap-2 px-4 items-center justify-items-center">
						...
						<>
							{resById?.BusinessTimes?.map((item, index) => (
								<div
									className="grid grid-cols-12 gap-2 px-4 py-1 items-center justify-items-center "
									key={index}
								>
				...
				<div className=" px-4 py-2">
					...
					<div className="grid grid-cols-12 gap-2 px-4 py-2 items-center justify-items-center ">
